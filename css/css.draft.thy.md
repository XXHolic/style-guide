...
- 如果有条件，给出规范大纲，让团队成员根据大纲填写自己觉得合理的规范，然后找个时间，一条条进行对比，有异议的，通过投票方式选择，最后归纳出对应的规范。如果没有条件，负责主导的人，先给出整体的规范，然后让团队成员进行预先查看并给出反馈，根据反馈，挑出有异议的规范，进行详细讨论。
- 随着规范的实施，很可能出现先得问题，这个时候就要及时沟通并定下规范，逐步的完善规范。
